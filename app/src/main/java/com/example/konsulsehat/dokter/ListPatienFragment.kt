...
class ListPatienFragment : Fragment(), AppointmentAdapter.ClickListener  {
...
//    lateinit var a: TextView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_list_patien, container, false)

        loggedInUser = arguments?.getString("loggedInUser")

        recyclerView = view.findViewById(R.id.rvPatientList)
